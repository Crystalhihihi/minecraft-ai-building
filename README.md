...
| 模型路由（08-08 起） | 地标树建造切换到 deepseek-v4-flash：14/14 成功，均值 7.9 分钟/棵、¥0.24/棵——比 K3 档快 2.2 倍、便宜约 96% |
| 成本（K3 真实定价重算） | 91 会话总成本 ¥345（曾按 K2 价误记 ¥144）；单栋均值 ¥4.84；E2 庄园 ¥8.50。重算口径与证据见 docs/quant-audit-2026-08-13.md |
