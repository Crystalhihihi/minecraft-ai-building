...
| giant_tree | 巨树/景观大树 v7(阔叶云片系: 顶梢干贯顶+主枝样条+辐扇+沿枝簇生叶+全程圆台+盘旋棱脊; 贴地爬根 crawl/flare+干径>=冠幅/4 护栏+blob 去壳+tuft 参数化; **fantasy 幻想地标系 4 卡**(矮胖撑伞+花椰菜大叶团+基座巨化+干纵纹)+**decor 装饰钩子**(光点/灯笼/垂藤); 19 preset; 高 10-150 地标直出; 针叶/棕榈/垂柳走开下面三个) |
